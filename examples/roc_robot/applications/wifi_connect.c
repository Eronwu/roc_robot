...
#define WLAN_SSID "emakefun"
#define WLAN_PASSWORD "emakefun501"
#define NET_READY_TIME_OUT (rt_tick_from_millisecond(15 * 1000))

#define WIFI_CONNECT_LED_PIN    PIN_LED_G
...
int wifi_auto_connect(void)
{
   ...
   // rt_pin_write(WIFI_CONNECT_LED_PIN, PIN_LOW);
    ...
    if (result == RT_EOK) {
        ...
        if (result == RT_EOK)
        {
            ...
            rt_pin_mode(WIFI_CONNECT_LED_PIN, PIN_MODE_OUTPUT);
            rt_pin_write(WIFI_CONNECT_LED_PIN, PIN_HIGH);
